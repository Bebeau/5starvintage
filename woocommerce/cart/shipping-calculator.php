...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<a href="#" class="shipping-calculator-button btn btn-default btn-block"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a>
	...
	<section class="shipping-calculator-form clearfix">
		...
		<button type="submit" name="calc_shipping" value="1" class="button btn btn-deafult pull-right"><?php _e( 'Update Totals', 'woocommerce' ); ?></button>

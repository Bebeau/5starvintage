...
<div class="col-lg-12 col-md-12">
	...
	<p class="myaccount_address alert alert-info centered">
	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address col-md-6">
		<header class="title">
			<div class="row">
				...
				<div class="col-md-4">
					<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit btn btn-default btn-block">
		...
		<address>
			<?php
				...
				if ( ! $formatted_address )
					_e( '<p class="alert alert-info centered">You have not set up this address.</p>', 'woocommerce' );
				else

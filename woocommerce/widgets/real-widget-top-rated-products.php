...
class Real_Widget_Top_Rated_Products extends WP_Widget {
	 ...
	 * @return void
	 */
	function Real_Widget_Top_Rated_Products() {
		...
		if ($top_rated_posts->have_posts()) :
			...
			if ( $title ) echo $before_title . $title . $after_title;
				...
				<ul class="product_list_widget list-unstyled">
					...
					?>
					<li class="row">
						<a href="<?php echo esc_url( get_permalink( $top_rated_posts->post->ID ) ); ?>" title="<?php echo esc_attr($top_rated_posts->post->post_title ? $top_rated_posts->post->post_title : $top_rated_posts->post->ID); ?>"></a> 

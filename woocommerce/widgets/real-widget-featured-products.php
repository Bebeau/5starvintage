...
class Real_Widget_Featured_Products extends WP_Widget {
	 ...
	 * @return void
	 */
	function Real_Widget_Featured_Products() {
...
?>
		...
		<div class="thumbnail">
			...
			<?php while ($r->have_posts()) : $r->the_post(); global $product; ?>
				...
				<li>
					<a class="link" href="<?php echo esc_url( get_permalink( $r->post->ID ) ); ?>" title="<?php echo esc_attr($r->post->post_title ? $r->post->post_title : $r->post->ID); ?>"></a>
